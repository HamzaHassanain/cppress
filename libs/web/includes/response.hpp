 ...
 * the lower-level cppress::http::http_response class. It adds web framework-specific
...
public:
     ...
     * @param status_message Descriptive status message (e.g., "OK", "Not Found", "Internal Server
     * Error")
     *
     ...
     *
     * @note If no status_message is provided, a default message will be set based on the status
     * code:
     ...
     */
    virtual void add_cookie(const std::string& name, const std::string& cookie,
