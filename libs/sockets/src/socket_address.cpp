...
// Constructs socket address from IP, port, and family components, creating appropriate sockaddr
// structure
socket_address::socket_address(const port& port_id, const ip_address& address,
