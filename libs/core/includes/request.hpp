 ...
 *
 * This file defines the request class, which encapsulates an incoming
 ...
 *
 * The request object is created internally by server and passed to
 * user callbacks. Users should never construct request directly.
 *
 * @example
 * @code
...
public:
     ...
     * Based on the "Connection" header and HTTP version.
